...
class GameActivity : BaseGameActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Config.firebaseData != null) {
            ...
            if (Config.firebaseData.admobEnable) admobAd = AdmobAds(this@GameActivity)
            if (Config.firebaseData.facebookEnable) facebookAd = FacebookAds(this@GameActivity)
            if (Config.firebaseData.unityEnable) unityAd = UnitysAds(this@GameActivity)
            if (Config.firebaseData.mediationIS) ironSourceAds = IronSourceAds(this@GameActivity)
