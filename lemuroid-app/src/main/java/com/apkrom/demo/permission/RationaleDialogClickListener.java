...
public class RationaleDialogClickListener implements DialogInterface.OnClickListener{
	...
	private EasyPermission.PermissionCallbacks mCallbacks;
	private RationaleDialogConfig mConfig;
	private Object mHost;
	private EasyPermission.RationaleCallbacks mRationaleCallbacks;

	RationaleDialogClickListener(RationaleDialogFragmentCompat rationaleDialogFragmentCompat, RationaleDialogConfig rationaleDialogConfig, EasyPermission.PermissionCallbacks permissionCallbacks, EasyPermission.RationaleCallbacks rationaleCallbacks) {
		Object obj;
	...
	RationaleDialogClickListener(RationaleDialogFragment rationaleDialogFragment, RationaleDialogConfig rationaleDialogConfig, EasyPermission.PermissionCallbacks permissionCallbacks, EasyPermission.RationaleCallbacks rationaleCallbacks) {
	...
	public void onClick(DialogInterface dialogInterface, int i) {
		...
		if (i == -1) {
			...
			EasyPermission.RationaleCallbacks rationaleCallbacks = this.mRationaleCallbacks;
			...
			EasyPermission.RationaleCallbacks rationaleCallbacks2 = this.mRationaleCallbacks;
	...
	private void notifyPermissionDenied() {
		EasyPermission.PermissionCallbacks permissionCallbacks = this.mCallbacks;
